...
function Portal() {
  ...
  return principal ? <><Dashboard /><div className="shell"><main className="mx-auto max-w-7xl px-4 pb-10 sm:px-6"><ShopOsWorkspace /><ShopOsFloorControl /></main></div><LocalMap /></> : <Login />;
}
